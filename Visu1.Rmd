...
gridB.sf %>% rename(Masse = col) %>%  
  ...
  labs(title = "Répartition géographique de la masse des oiseaux", 
       ...
       caption = "Aide à  la lecture de l'échelle : une couleur pour 10 désigne le groupe d'oiseaux dont la masse est \n supérieure à 18% des individus mais inférieure aux 20% suivants. Une couleur pour 50 correspond \n au dernier pourcentage d'individus ayant la plus forte masse.")+
  theme(plot.title = element_text(hjust = 0.2, vjust=0, size = 15, family="Montserrat", face="bold"),
        ...
        plot.caption = element_text(hjust = 0.55, vjust=6, family="Montserrat", face = "italic"),

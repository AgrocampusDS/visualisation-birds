...
# transformer grid en objet sf
gridB <-st_as_sf(gridB)
gridB$WorldID <-as.factor(as.character(gridB$WorldID))

# associer n_sp à m'objet spatiale
species_map <-left_join(gridB, rangeData)
```
